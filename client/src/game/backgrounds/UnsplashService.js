...
export class UnsplashService {
  constructor() {
    ...
    this.USE_MOCK_DATA =
      !this.accessKey || this.accessKey === "YOUR_UNSPLASH_ACCESS_KEY";
  }
  ...
  getSearchQuery(lat, lng, location_name) {
    ...
    const locations = {
      ...
      36.46: "death valley national park desert dunes badwater basin",
    ...
    const gradients = [
      ...
      },
      {
        ...
        gradient: {
          ...
          stops: [
            {
              color: this.interpolateColor("#87CEEB", "#4A90E2", latNorm),
              position: 0,
            },
            {
              color: this.interpolateColor("#98D8F8", "#5BA0F2", latNorm),
              position: 0.4,
            },
            {
              color: this.interpolateColor("#5BA0F2", "#3A7BD5", latNorm),
              position: 0.6,
            },
            {
              color: this.interpolateColor("#4682B4", "#2E5D8B", latNorm),
              position: 1,
            },
          ],
        },
